...
var UniversalClientDef=function(protocol){
    ...
    JavascriptUniversalClient.connect = function (connectionInfo, errorFunctionHandle, connectedFunctionHandle) {
        ...
        if (protocol.toLowerCase() === "amqp") {
                ...
                requirejs([
                    'node_modules/kaazing-javascript-universal-client/node_modules/kaazing-javascript-gateway-client/WebSocket.js',
                    'node_modules/kaazing-javascript-universal-client/JMSUniversalClient.js'
                    ], function () {
